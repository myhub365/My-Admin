								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											...
											<div class="mt-3">
												<h4><span><?php echo $row['first_name'] ;?> </span><span><?php echo $row['last_name'] ?></span></h4>
								...
								<div class="card">
									<div class="card-body">
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" value="<?php echo $row['first_name']?> <?php echo $row['last_name'] ?>" />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
